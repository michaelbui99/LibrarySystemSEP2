...
class ReservationDAOImplTest
{
  ...
  @BeforeEach void setUP() throws SQLException
  {
    ...
    borrower = new Borrower("111111-1122", "Lilian", "Bittar",
        "bittarlily@gmail.com", "+4526700792", null, "password");
    book = new Book(1, 4, "one", "catman", "2000-10-10", "cat live", null,
        "Voksen", "Dansk", "5444", 200, null, null);
  }
  ...
  @Test void creatReservationTest() throws SQLException
  {
    ...
    assertEquals(1,
        reservationDAO.getAllReservationsByCPR(borrower.getCpr()).size());
  }

  @Test void getAllReservationByCPRReturnsAllReservationsTest()
      throws SQLException
  {
    ...
    List<Reservation> reservations = reservationDAO
        .getAllReservationsByCPR("111111-1122");
    assertEquals(2, reservations.size());
  }

  @Test void getAllReservationsByCPRReturnsCorrectReservation()
      throws SQLException
  {
  ...
  @Test void endReservationTest() throws SQLException
  {
    ...
    assertEquals(2,
        reservationDAO.getAllReservationsByCPR(borrower.getCpr()).size());
    Reservation reservation = new Reservation(book, borrower, LocalDate.now(),
        1, false);
